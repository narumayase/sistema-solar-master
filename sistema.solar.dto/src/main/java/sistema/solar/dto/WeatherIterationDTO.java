 ...
 * @author watas
 */
public class WeatherIterationDTO {
	 ...
	 */
	public WeatherIterationDTO(int countDroughtPeriod, int countRainyPeriod, int countOptimalConditions, List<Integer> daysWithMaxRain) {
		super();
